...
from watchlist_app.api.v1.views import ReviewModelViewSet, StreamPlatformMovieViewSet, MovieViewSet
...
router.register("",MovieViewSet, basename="watch")
urlpatterns = [
    # path("list/<str:title>/", views.MovieListAV.as_view(), name="movie_list"),
    # path("list/<int:pk>/", views.MovieDetailAV.as_view(), name="movie_detail"),

    # path("stream/", views.StreamPlatform.as_view(), name="stream_list"),
